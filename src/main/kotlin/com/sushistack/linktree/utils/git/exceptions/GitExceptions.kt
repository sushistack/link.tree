...
class GitUnstagedChangesException(message: String) : GitException(message)
...
fun handleGitException(errorMessage: String): GitException {
    ...
    val unstagedChanges = "You have unstaged changes" in errorMessage
    ...
    return when {
        ...
        unstagedChanges -> GitUnstagedChangesException("Unstaged changes detected.")
